...
public class WithoutBrokerIntegrationTest extends IntegrationTestBase {

    @Test
    public void testCorrectLogin_ShouldInternalServerError() throws Exception {
    ...
    @Test
    public void testProxyPublicResourceWithoutAuthentication_ShouldInternalServerError() throws Exception {
    ...
    @Test
    public void testProxyWrongPath_ShouldInternalServerError() throws Exception {
